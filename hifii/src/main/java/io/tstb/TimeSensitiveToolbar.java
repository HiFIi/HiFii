...
public class TimeSensitiveToolbar extends HiFii {
    /**
    ...
    protected static final int RevealDuration = 600;
    private static final int toolBarColorChangeDuration = 800;
    private static final int statusBarColorChangeDuration = 400;
    private static final int fadeInText = 300;
    ...
    private static final int BACKGROUND_COLOR_INITIAL_ANIMATION_DURATION_MILLIS = 2000;
    //  private static Toolbar mToolbar;
    private static ImageView timeOfDayIV;
    private static HiFiiTextView timeOfDayText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timeOfDayText = (HiFiiTextView) findViewById(R.id.timeOfDayText);
    ...
    private final void darkenRL() {
        rl.postDelayed(new Runnable() {
            ...
            public final void run() {
                ...
                final Integer colorTo = getResources().getColor(R.color.perfect_dark_bg);
                ValueAnimator colorAnimation = ValueAnimator.ofObject(new ArgbEvaluator(), colorFrom, colorTo);
                colorAnimation.setDuration(statusBarColorChangeDuration);
                colorAnimation.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
    ...
    private final void setNavBarNightColor() {
        ...
        final Integer colorTo = darkenColor(getResources().getColor(R.color.perfect_dark_bg));
        ValueAnimator colorAnimation = ValueAnimator.ofObject(new ArgbEvaluator(), colorFrom, colorTo);
        colorAnimation.setDuration(statusBarColorChangeDuration);
        colorAnimation.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
