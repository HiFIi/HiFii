 ...
 */
public class About extends HiFii implements ObservableScrollView.Callbacks {
    ...
    private DiagonalLayout parallaxDL;
    ...
    private void initViews() {
        ...
        parallaxDL = (DiagonalLayout) findViewById(R.id.parallaxDL);
        draweeView = (ImageView) findViewById(R.id.session_photo);
